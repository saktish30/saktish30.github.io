...
function GetBooking() {
    let url = 'https://api.sheety.co/7b9ad08baff0b099b3bec9b50c68ef5e/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/7b9ad08baff0b099b3bec9b50c68ef5e/bookingApp/bookings' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
